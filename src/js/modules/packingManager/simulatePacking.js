import { processPackedObjects } from "./processPackedObjects";
import { updateProgressDisplay } from "../../utils/binPackingAPI";

export function   // 模擬打包功能
...
// 模擬打包算法
function simulatePackingAlgorithm(objects, containerSize) {
...
// 計算體積利用率
function calculateVolumeUtilization(packedObjects, containerSize) {
